...
export default async function getMessageType(caregiver, messageTrackerCaregiver){
    let messageType = "";
    ...
    let valid = await messageTrackerValidation(messageType, messageTrackerCaregiver);
