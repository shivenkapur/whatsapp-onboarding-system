...
export default async function sendMessage(
  ...
  try {
    ...
    for (let line in split_message) {
      ...
      await page.type(selectors.messageBoxArea, split_message[line], {
        delay: 1,
      });
      //await page.keyboard.down('Shift');
      if (!test) await page.keyboard.press("Enter");
    }

    await page.waitFor(1000);

    if (!test) await pageFunctions.click(page, selectors.sendMessageButton);
    await page.waitFor(1000);
